...
public:
  ...
  // 先序遍历
  void pre_order_traversal() { __pre_order_traversal_recure(this->root); }
  // 中序遍历
  void in_order_traversal() { __in_order_traversal(this->root); }
  // 后序遍历
  void post_order_traversal() { __post_order_traversal(this->root); }
  // 层次遍历，从上到下，从左到右
  void level_order_traversal();
  // 求树高度
  int binary_tree_height() { return __binary_tree_height(this->root); }
